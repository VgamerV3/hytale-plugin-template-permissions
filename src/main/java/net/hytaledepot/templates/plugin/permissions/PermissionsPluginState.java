...
public final class PermissionsPluginState {
  private final AtomicReference<PermissionsPluginLifecycle> lifecycle = new AtomicReference<>(PermissionsPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Permissions";
  private volatile String dataDirectory = "";

  public PermissionsPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(PermissionsPluginLifecycle next) {
    lifecycle.set(next);
  }
